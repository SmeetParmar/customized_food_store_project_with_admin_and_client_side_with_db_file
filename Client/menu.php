...
<div class="dropdown">
  <button class="btn btn-info fs-4 my-2 dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
   Categories
  </button>
  <ul class="dropdown-menu fs-6" aria-labelledby="dropdownMenuButton1">
  	<li><a class="dropdown-item fs-5" href="menu.php?nm=all">All Products</a></li>
  		<?php 
					...
					{
					?> <li><a class="dropdown-item fs-5" href="menu.php?nm=<?php echo $cat["Name"]; ?>"><?php echo $cat["Name"]; ?></a></li>
							 <?php 
								}
							 ?>
  </ul>
